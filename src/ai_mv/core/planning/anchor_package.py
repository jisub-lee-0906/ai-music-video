...
def _pose_anchor_bank(protagonist_anchor: str, wardrobe_anchor: str) -> list[dict]:
    specs = [
        ...
        },
        {
            ...
            "camera_angle": "front_three_quarter",
            "subject_position": "center",
            "intended_shot_functions": ["search", "world_bridge", "lighthouse", "cliff_wind"],
        ...
        {
            "anchor_id": "ANCHOR_POSE_LIGHTHOUSE_LOOKOUT_STANCE",
            "pose_family": "lighthouse_lookout_stance",
            "framing": "full",
            "camera_angle": "front_three_quarter",
            "subject_position": "left_third",
            "intended_shot_functions": ["wound_setup", "threshold", "lighthouse", "lookout_pause"],
            "pose_instruction": "a full-body lighthouse lookout pause, weight settled, head slightly turned toward the horizon, jacket silhouette readable, studio pose card",
        },
        {
            "anchor_id": "ANCHOR_POSE_LIGHTHOUSE_WIND_FACE",
            "pose_family": "lighthouse_wind_face",
            "framing": "medium",
            "camera_angle": "front_three_quarter",
            "subject_position": "center",
            "intended_shot_functions": ["release", "chorus", "lighthouse", "wind_facing"],
            "pose_instruction": "a medium wind-facing lighthouse release pose, shoulders braced, face readable, jacket collar and upper wardrobe readable, studio pose card",
        },
        {
        ...
        {
            "anchor_id": "ANCHOR_POSE_ARCTIC_AURORA_LOOKUP",
            "pose_family": "arctic_aurora_lookup",
            "framing": "medium",
            "camera_angle": "front_three_quarter",
            "subject_position": "center",
            "intended_shot_functions": ["wound_setup", "arctic", "aurora", "lookup_pause"],
            "pose_instruction": "a medium arctic aurora lookup pose, chin lifted slightly, face and parka collar readable, hands relaxed and empty, studio pose card",
        },
        {
            "anchor_id": "ANCHOR_POSE_ARCTIC_COLD_FIELD_PAUSE",
            "pose_family": "arctic_cold_field_pause",
            "framing": "medium",
            "camera_angle": "front_three_quarter",
            "subject_position": "center",
            "intended_shot_functions": ["release", "arctic", "cold_field", "quiet_hold"],
            "pose_instruction": "a medium cold-field release pause, body still after crossing, shoulders settled, face and winter outfit readable, studio pose card",
        },
    ]
