        ...
        "ref_adapter": [
            {
                ...
                "raw_prompt_clauses": {
                    ...
                    "blocking_role": str(row.get("blocking_role", "")).strip(),
                    "entry_side": str(row.get("entry_side", "")).strip(),
                    "travel_axis": str(row.get("travel_axis", "")).strip(),
                    "frame_bias": str(row.get("frame_bias", "")).strip(),
                    "arrival_side": str(row.get("arrival_side", "")).strip(),
                    "camera_relation": str(row.get("camera_relation", "")).strip(),
                    ...
                    "applied_global_prompt_rules": list(row.get("applied_global_prompt_rules", [])),
                    "applied_archetype_rules": list(row.get("applied_archetype_rules", [])),
                    "applied_golden_structure": str(row.get("applied_golden_structure", "")).strip(),
                    "rule_precedence_summary": str(row.get("rule_precedence_summary", "")).strip(),
