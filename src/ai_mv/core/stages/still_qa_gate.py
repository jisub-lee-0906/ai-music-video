...
_BLOCKING_PHRASES: tuple[tuple[str, str], ...] = (
    ...
    ("distant_human_silhouette", "distant human silhouette"),
    ("distant_human_silhouette", "distant human silhouettes"),
    ("distant_human_silhouette", "human silhouette centered down the street"),
    ("distant_human_silhouette", "distant figure down the street"),
    ("distant_human_silhouette", "distant person down the street"),
    ("bystander_clone_ambiguity", "red raincoat bystander"),
    ("bystander_clone_ambiguity", "background bystander in the same outfit"),
