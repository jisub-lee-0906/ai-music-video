...
def run_review_stage(stage_input: StageInput, *, duration_fn=ffprobe_duration) -> StageOutput:
    ...
    report = build_review_report(
        ...
        style_bible=stage_input.payload.get("style_bible") if isinstance(stage_input.payload.get("style_bible"), dict) else {},
