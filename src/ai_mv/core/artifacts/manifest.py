...
def write_manifest(state: dict, payload: dict) -> None:
    ...
    out = {
        ...
        "scene_plan_v2": dict(payload.get("scene_plan_v2", {})),
        "director_plan_v2": dict(payload.get("director_plan_v2", {})),
        "render_plan_v2": dict(payload.get("render_plan_v2", {})),
        "backend_preview_v2": dict(payload.get("backend_preview_v2", {})),
