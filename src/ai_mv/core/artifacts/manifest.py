...
def write_manifest(state: dict, payload: dict) -> None:
    ...
    out = {
        ...
        "scene_plan": dict(payload.get("scene_plan", {})),
        "director_plan": dict(payload.get("director_plan", {})),
        "render_plan": dict(payload.get("render_plan", {})),
        "backend_preview": dict(payload.get("backend_preview", {})),
