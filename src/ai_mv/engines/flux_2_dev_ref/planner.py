...
def _planner_prompt(config: dict, payload: dict, anchors: list[dict], carry: str) -> str:
    ...
    return (
        ...
        "Another strong example: 'The same anime girl, now looking back over one shoulder as her hair swings across her cheek. Off-center medium shot. Flat cel shading, thick clean outlines.' "
        "Another strong example: 'The same anime girl, now dragging the umbrella tip through the puddle and breaking the surface rings. Tight puddle insert shot. Flat cel shading, thick clean outlines.' "
        "Another strong example: 'The same anime girl, now pressing two fingers to the train glass as station lights split across her reflection. Tight reflective shot. Flat cel shading, thick clean outlines.' "
        ...
        "Bad example: 'The same anime girl, now drifting through the forecourt. Wide shot. Flat cel shading, thick clean outlines.' "
        "Bad example: 'The same anime girl, now looking ahead. Medium shot. Flat cel shading, thick clean outlines.' "
        "Bad example: 'The same anime girl, now watching the streetlights slide across the carriage glass. Wide shot. Flat cel shading, thick clean outlines.' "
