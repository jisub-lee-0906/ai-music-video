...
def _planner_prompt(config: dict, payload: dict, anchors: list[dict], carry: str) -> str:
    ...
    return (
        ...
        "The continuity_clause should describe a flat graphic anime character look with thick clean outlines, simplified cute features, and clear color blocking. "
        ...
        "Preserve the same cute symbolic face, large graphic eyes, clean hair silhouette, and compact readable body proportions from the master anchor. "
        ...
        "Another valid example: 'The same anime girl, now turning her eyes sharply to the left. Tight close-up. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now stepping through the ticket gate with her coat hem swinging behind her. Off-center walking shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now pressing one hand to the train window as city bands streak behind the glass. Layered train-window shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now stopping at the curb as puddle rings widen around her shoes. Low reflective street shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now pulling her shoulder back as a blue sign stripe crosses her jacket. Off-center platform shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now looking back over one shoulder as her hair swings across her cheek. Off-center medium shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now dragging the umbrella tip through the puddle and breaking the surface rings. Tight puddle insert shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Another strong example: 'The same anime girl, now pressing two fingers to the train glass as station lights split across her reflection. Tight reflective shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now posing beautifully. Nice shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now standing in empty space. Medium shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now leaning slightly toward the mood. Off-center shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now drifting through the forecourt. Wide shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now looking ahead. Medium shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        "Bad example: 'The same anime girl, now watching the streetlights slide across the carriage glass. Wide shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
        ...
        "Example prompt_text: 'The same anime girl, now fiercely smashing the guitar onto the ground, bending her knees. Extreme low-angle dynamic shot. Flat graphic anime shading, thick clean outlines, simplified cute features.' "
