...
def _planner_prompt(config: dict, payload: dict, anchors: list[dict], carry: str) -> str:
    ...
    return (
        ...
        "Another strong example: 'The same anime girl, now turning beneath the blue signboard as the platform glow catches her hair. Off-center platform shot. Clean manga-anime shading, thick clean outlines, readable anime features.' "
        "Another strong example: 'The same anime girl, now bracing one hand at the ticket gate glass while her shoulder turns away. Tight gate-side shot. Clean manga-anime shading, thick clean outlines, readable anime features.' "
        ...
        "Bad example: 'The same anime girl, now stepping forward. Medium shot. Clean manga-anime shading, thick clean outlines, readable anime features.' "
