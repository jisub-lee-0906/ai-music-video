...
def _planner_prompt(config: dict, payload: dict, anchors: list[dict], carry: str) -> str:
    ...
    return (
        ...
        "prompt_text should foreground heroine identity through face, posture, silhouette, and readable environment before mentioning any prop. "
        ...
        "Keep heroine identity primary; in close shots the face can lead, while in wider motion shots silhouette, posture, and travel direction can lead. Props and bags should stay secondary unless the shot is a brief intentional detail insert. "
