...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "Do not overuse split-screen, diptych, mirrored-face, doubled-subject, centered two-body, bilateral balance, or static cover-pose close crops across adjacent beats; reserve them for isolated impact beats rather than the default graphic solution. "
        "Avoid composition phrases that imply tight face crop, emblematic badge-like portrait, or paired-figure default staging; favor one living character in space, a side turn, a walking line, or a small figure against graphic planes. "
