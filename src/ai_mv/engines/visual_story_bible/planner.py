...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "space_event should read like a drawable motion statement, for example 'The gate opens and snaps back', 'The train window throws narrow light bands across the glass', or 'The puddle rings widen with each step'. "
        ...
        "For graphic-led beats, prefer a concrete visual hit, for example crossing light bands, doubled shadows, stacked sign strips, or a split reflection across glass. "
        "Good object-led beat example: 'A folded note loosens in her hand while gate lights ripple across the wet floor'. "
        "Good space-led beat example: 'Train window bands slide past and cut the platform reflection into thin strips'. "
        "Good graphic-led beat example: 'Stacked sign bands and crossing light strips lock into one reflected frame'. "
        ...
        "For final payoff beats, prefer concrete world or object resolutions such as gate arms opening in sequence, train windows clearing, sign bands aligning, puddle rings merging, or a final light strip narrowing into dark. "
        ...
        "If a section can be expressed through gate bars, passing windows, sign bands, puddle rings, floor reflections, vending glow, or curb lines, choose those motifs before adding new heroine coverage. "
