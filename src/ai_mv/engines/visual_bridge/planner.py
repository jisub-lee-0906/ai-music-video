...
def _planner_prompt(audio_map: dict, sections: list[dict]) -> str:
    ...
    return (
        ...
        "story_beat must be a short plain-English action or emotional transition for that section, such as searching, passing by, hesitating, opening up, separating, or converging. "
