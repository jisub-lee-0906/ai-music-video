...
def _planner_prompt(audio_map: dict, sections: list[dict]) -> str:
    ...
    return (
        ...
        "If no prop is clearly necessary, keep the lead identity anchored by wardrobe silhouette, hair styling, and accessories instead of inventing a handheld object. "
        ...
        "Build the brief like a finished music video sequence, not a fashion editorial: sections should imply coverage variety, spatial progression, and changes in camera relation over time. "
        ...
        "Bad story_beat examples: searching, opening up, separation, confidence, romantic release. "
        ...
        "Verse staging should often privilege travel, negative space, profile drift, reflected pass-bys, or shoulder-led movement over centered front-facing portraiture. "
        "Bridge staging should feel like emotional separation or suspended breath: silhouette distance, reflected profile, paused walk-through, or isolated framing are stronger than another beauty close-up. "
        "Bridge should feel like a real turn in the video, not just a quieter pretty frame: use interruption, isolation, obstruction, or a held stop that changes what the final return will mean. "
        "Post-chorus staging should usually act like connective punctuation, not another lead glamour frame. "
        ...
        "Reserve the most direct subject-facing payoff framing for major returns; do not let every section resolve into the same frontal portrait grammar. "
        "Outro should not feel like an extra verse; it should leave one strong residue image, such as a receding figure, a held reflection, or the space after she has passed through it. "
