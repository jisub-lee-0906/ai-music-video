...
def _planner_prompt(audio_map: dict, sections: list[dict]) -> str:
    ...
    return (
        ...
        "Post-chorus staging should usually act like connective punctuation, not another hero glamour frame. "
        ...
        "Reserve the most direct hero-facing payoff framing for major returns; do not let every section resolve into the same frontal portrait grammar. "
