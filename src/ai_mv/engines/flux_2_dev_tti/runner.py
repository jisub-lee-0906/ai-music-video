...
def _pack_anchor(shot: dict, identity_anchor: str, shot_anchor: str | None = None) -> dict:
    ...
    return {
        ...
        "scene_change_level": str(shot.get("scene_change_level", "evolve")),
        "anchor_strategy": str(shot.get("anchor_strategy", "refine_anchor")),
        "continuity_basis": str(shot.get("continuity_basis", "world")),
