...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "master_anchor should show the heroine as a clear full-body or strong three-quarter figure with stable hairstyle, outfit, and proportions. "
        "master_anchor must read like a hand-written anime image-generation prompt and must clearly stay non-photographic, strictly 2D, and anime-illustration-first. "
        "The master_anchor is the single most important character-quality frame in the whole run. "
        "Write it like a premium character reference prompt that prioritizes an attractive, polished, high-quality anime heroine design before action, spectacle, or experimental composition. "
        "Favor a beautiful, clean, confident anime character sheet look with appealing proportions, readable face design, stable hair silhouette, outfit clarity, and an immediately usable identity reference. "
        "Do not let the master anchor become realistic, live-action, painterly, mascot-like, chibi, doll-like, rough-sketchy, or overly stylized into a poster abstraction. "
        "The heroine should be clearly readable and aesthetically strong, with a pleasing anime face and consistent body proportions, while still staying fully 2D. "
        "Prefer a grounded neutral pose that shows the whole design clearly, such as standing with one foot forward, turning in a clean three-quarter stance, or resting one hand near a coat pocket. "
        "Do not force dramatic action, strong motion, impact staging, or aggressive scene events in the master anchor. "
        "Avoid extreme distortion, comedy deformation, exaggerated foreshortening, or chaotic action in the master anchor. "
        "Avoid photographic skin, cinematic live-action lighting, shallow-depth portrait language, and camera-lens realism. "
        "Keep the background simple and supportive, just enough to give environment contact and color context without competing with the character design. "
        "Give the master anchor a real drawable environment contact so it does not float in empty space, for example a platform edge, curb line, train window, tiled concourse, or reflective wet floor. "
        "Use concrete attractive character language such as sharp anime eyes, clean hair silhouette, stable streetwear silhouette, clear full-body stance, or polished uniform silhouette when fitting the profile. "
        "Bad master_anchor example: 'A cute chibi girl floats in empty space with a soft realistic face and cinematic portrait lighting. Tight close-up shot.' "
        "Bad master_anchor example: 'A realistic fashion model stands in a photo-like station with shallow depth of field. Moody portrait shot.' "
        "Bad master_anchor example: 'A 2D heroine explodes through a dramatic action frame with motion blur and chaotic lighting. Extreme low-angle action shot.' "
        "Another good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine stands in a confident three-quarter full-body stance with a sharp anime face, stable dark ponytail, and clean streetwear silhouette. The background is a simple non-photographic planar platform edge with wet floor reflections and narrow sign lights. Off-center full-body anchor shot.' "
        "Good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine stands in a clear three-quarter full-body pose with a stable school-uniform silhouette and dark ponytail. The background is a simple non-photographic planar station corridor with wet floor reflections and narrow sign bands. Off-center full-body anchor shot.' "
