...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "Write it like a premium anchor image prompt that prioritizes an attractive, polished, high-quality anime heroine design before any experimental event logic. "
        "Favor a beautiful, clean, confident anime character sheet look with appealing proportions, readable face design, stable hair silhouette, and outfit clarity. "
        "Do not let the master anchor become realistic, live-action, painterly, mascot-like, chibi, doll-like, or rough-sketchy. "
        "Do not let the master anchor become an abstract poster, a symbol-only frame, a blank environment, or a purely graphic insert. "
        ...
        "Prefer a grounded pose that shows the whole design clearly, such as standing with one foot forward, turning in a clean three-quarter stance, or pausing with one hand near a coat pocket. "
        ...
        "Another good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine stands in a confident three-quarter full-body stance with a sharp anime face, stable dark ponytail, and clean streetwear silhouette. The background is a non-photographic planar platform edge with wet floor reflections and narrow sign lights. Off-center full-body anchor shot.' "
        "Good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine stands in a clear three-quarter full-body pose with a stable school-uniform silhouette and dark ponytail. The background is a non-photographic planar station corridor with wet floor reflections and narrow sign bands. Off-center full-body anchor shot.' "
