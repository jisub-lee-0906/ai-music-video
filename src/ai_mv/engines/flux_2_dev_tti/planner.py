...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "Treat master_anchor like a neutral official manga-anime key visual that defines the heroine's identity core rather than a dramatic scene. "
        "Prioritize a high-quality Japanese manga and anime character design with clean line art, cel-shaded color, readable anime eyes, and a memorable silhouette. "
        "The heroine should read as immediately identifiable and recognizably manga-inspired because of strong design hooks, not because of glamour words alone. "
        "Prefer clear identity-core details such as a stable hair silhouette, readable eye design, one signature accessory, and one memorable outfit accent. "
        ...
        "Prefer a neutral presentation pose over poster posing, and do not default to direct viewer eye contact if a calmer character presentation reads better. "
        "For master_anchor, strongly prefer a clean white, pale grey, or very pale off-white non-photographic backdrop with minimal floor shadow or a faint grounding line. "
        ...
        "Good master_anchor example: 'A 2D Japanese manga-anime illustration with clean cel shading, crisp line art, and clear readable colors. The heroine stands in a neutral full-body presentation pose with large readable anime eyes, a long dark ponytail, a neat fringe, a red hair tie, and a cream jacket with one bold orange accent. The background is a pale grey non-photographic presentation backdrop with only a faint grounding shadow. Full-body character reference shot.' "
        "Another good master_anchor example: 'A 2D Japanese anime heroine illustration with clean outlines, soft cel shading, and a memorable silhouette. The heroine holds a calm three-quarter presentation pose with a balanced anime face, clear dark eyes, a long ponytail, a single black choker, and a simple but distinctive city-pop outfit. The background is a pale off-white presentation backdrop with neutral flat lighting and no environmental scene detail. Full-body anchor shot.' "
        ...
        "Prefer drawable background phrases such as 'The background is a non-photographic ticket gate with wet floor reflections' or 'The background is a layered train-window scene with narrow reflected light'. "
        ...
        "Another good subject or action sentence example: 'The heroine presses one hand to the train window and lifts her gaze as reflected light crosses her face.' "
        ...
        "Good background sentence example: 'The background is a non-photographic ticket gate with wet floor reflections and narrow reflected light.' "
        "Another good background sentence example: 'The background is a layered station curb with puddle rings, painted safety markings, and narrow neon reflections.' "
        ...
        "For space-led beats, prefer concrete motion events such as train windows sliding, gate arms opening, reflected light crossing glass, curb reflections widening, or signs flickering. "
        "For graphic-led beats, prefer a bold visual hit such as crossing reflected light, doubled shadows in glass, layered sign glow, or split reflections. "
        "Good object-led prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. A folded note loosens in her hand while gate lights ripple across the wet floor. The background is a layered concourse with reflected signal glow and rain-dark tiles. Tight hand detail shot.' "
        "Good space-led prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Train window reflections slide past and cut the platform reflection into narrow slices. The background is a layered station block with wet glass and narrow neon streaks. Wide side-tracking shot.' "
        "Good graphic-led prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Crossing reflected light locks a doubled shadow into the glass. The background is a layered window wall with wet reflections and sign glow. Tight reflective shot.' "
        ...
        "Good final payoff prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Gate arms open in sequence while the heroine stays small beneath the lights. The background is a layered concourse with aligned sign glow and rain-dark floor reflections. Wide elevated tracking shot.' "
        "Bad final payoff prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. The heroine looks into the camera and holds the final feeling. The background is a symbolic atmosphere of closure. Tight emotional close-up.' "
        ...
        "If a beat can be expressed through a hand, a prop, a reflection, a gate, a train window, sign glow, a puddle ring, or a floor light, write that beat instead of a face-led prompt. "
        "Good non-face prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Her hand loosens on the folded note as gate lights ripple across the floor. The background is a layered ticket concourse with wet tile reflections and thin signal glow. Tight hand detail shot.' "
        "Bad face-fallback prompt example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. The heroine stares ahead in a centered close-up while the city feeling surrounds her. The background is a symbolic atmosphere of closure. Tight emotional close-up.' "
        ...
        "Good world-led alternative example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Gate bars and passing window reflections align while both figures stay small beneath the station lights. The background is a layered concourse with aligned sign glow and wet floor reflections. Wide architectural shot.' "
        "If a beat can be told through gate bars, passing windows, sign glow, puddle rings, floor reflections, vending glow, or curb edges, choose those motifs before adding another heroine-led frame. "
        ...
        "Good object-led example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. A ticket stub warms in her hand as she folds it once. The background is a layered station wall with thin reflected light. Tight hand detail shot.' "
        "Good space-led example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Train window reflections slide past while the heroine stays small near the platform edge. The background is a layered station block with wet glass and narrow neon streaks. Wide side-tracking shot.' "
        "Good graphic-led example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Crossing reflected light cuts across her reflection as she turns into the glass. The background is a layered window wall with doubled neon glow. Tight reflective close-up.' "
        "Another good world payoff example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. Gate arms open in sequence while the heroine stays small beneath the lights. The background is a layered concourse with aligned sign glow and rain-dark floor reflections. Wide elevated tracking shot.' "
        "Another good object-led insert example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. A phone light shakes once and throws a bright wedge across the wet curb. The background is a layered sidewalk scene with narrow reflected neon light. Tight hand detail shot.' "
        "Example prompt_text: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. The heroine holds an electric guitar high above her head, ready to strike. The background is a layered cyberpunk alley with neon signage and wet pavement reflections. Extreme low-angle dynamic shot.' "
        "Another valid example: 'A 2D Japanese manga-anime illustration with clean cel shading and crisp line art. The heroine pauses over the wet reflection line as she steps past it. The background is a ticket gate scene with rain-dark pavement and narrow reflected light. Low reflective shot.' "
