...
def _planner_prompt(config: dict, payload: dict) -> str:
    ...
    return (
        ...
        "Prioritize an attractive, polished, high-quality anime heroine design with a stable face, hair silhouette, outfit silhouette, and body proportions. "
        "Treat master_anchor like a premium anime key visual reference, not a plain model sheet. "
        "The heroine should read as cute, stylish, and immediately likable at first glance. "
        "Prefer a charming anime face, large clear eyes, a clean fringe or ponytail silhouette, and a stylish outfit with one memorable design accent. "
        "Even though the pose is grounded and neutral, the character should still feel fashionable, premium, softly cute, and deliberately designed rather than generic. "
        "Aim for a lovable commercial anime heroine design rather than a severe or stern fashion illustration. "
        ...
        "The background should feel like a clean anime character presentation sheet, not a real photographed location. "
        "Do not let the master anchor become realistic, live-action, painterly, chibi, mascot-like, doll-like, or a chaotic action frame. "
        "Good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine stands in a confident three-quarter full-body pose with a cute anime face, bright dark eyes, a soft dark ponytail, and a stylish navy streetwear silhouette with one clean red accent. The background is a clean white non-photographic backdrop with only a faint grounding shadow beneath her shoes. Full-body character reference shot.' "
        "Another good master_anchor example: 'A 2D graphic anime illustration with flat cel shading and thick clean outlines. The heroine holds a calm full-body pose with balanced proportions, crisp bangs, large bright anime eyes, and a premium urban outfit silhouette that still feels youthful and charming. The background is a pale off-white presentation backdrop with a minimal floor cue and no environmental scene detail. Full-body anchor shot.' "
